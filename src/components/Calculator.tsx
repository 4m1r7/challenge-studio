...
export default function MobileMenu({
  ...
  return (
    <motion.div
      className={`fixed right-0 top-10 z-50 flex h-[100svh] w-[100vw] -translate-y-10 flex-col items-center justify-start overflow-scroll px-16 pb-14 pt-12 md:absolute
